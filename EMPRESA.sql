...
SELECT * FROM EMPRESA.FUNCIONARIO WHERE ENDERECO LIKE '%Sao Paulo%' or ENDERECO LIKE '%Curitiba%' ORDER BY PNOME;

SELECT * FROM EMPRESA.FUNCIONARIO WHERE ENDERECO NOT LIKE '%Sao Paulo%' ORDER BY PNOME;

SELECT * FROM EMPRESA.FUNCIONARIO ORDER BY SALARIO DESC;

SELECT * FROM EMPRESA.FUNCIONARIO WHERE Cpf_supervisor IS NULL;

SELECT * FROM EMPRESA.FUNCIONARIO WHERE Cpf_supervisor IS NOT NULL ORDER BY PNOME;

SELECT * FROM EMPRESA.FUNCIONARIO ORDER BY SALARIO DESC LIMIT 3;
...
SELECT * FROM EMPRESA.FUNCIONARIO WHERE YEAR (DATANASC) = 1972; 

SELECT * FROM EMPRESA.FUNCIONARIO WHERE SALARIO IN (25000, 30000);
...
SELECT *
FROM FUNCIONARIO
WHERE SALARIO BETWEEN 30000.00 AND 40000.00
AND DNR = '5';
